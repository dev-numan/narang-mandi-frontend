      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-2 px-4 py-3 sm:gap-4 sm:py-4">
        <Link to="/" className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <div className="min-w-0">
            <h1 className="truncate text-lg font-bold leading-[1.9] text-brand sm:text-2xl">{siteName}</h1>
            {settings?.tagline && (
              <p className="mt-1 truncate text-xs leading-[1.9] text-gray-500">{settings.tagline}</p>
            )}
          </div>
        </Link>
